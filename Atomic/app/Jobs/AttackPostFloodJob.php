...
class AttackPostFloodJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try{
            ...
            $attackCommand .= "Post_Flood -url=\"{$params['url']}\" -params=\"{$params['params_post']}\" -workers={$params['atacantes']} -process-timeout={$params['tempo']} ";
